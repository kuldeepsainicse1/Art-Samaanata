                ...
                <div className="col-lg-12">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                        <div className="features-small-item">
                            ...
                            <h5 className="features-title">Modern Objective</h5>
                            <p>Organizers and participants directly approach with defined objectives to be achieved from target participants and Incentives</p>
                        </div>
                    </div>
